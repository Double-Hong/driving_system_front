      ...
      <el-container class="el-container">
        <el-header>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="6">
              <div class="grid-content ep-bg-purple"/>
              考生姓名：{{ myPageInfo.userName }}
            </el-col>
            <el-col :span="6">
              <div class="grid-content ep-bg-purple"/>
              时间：{{ time.hour }}:{{ time.minute }}:{{ time.second }}
            </el-col>
            <el-col :span="6">
              <div class="grid-content ep-bg-purple"/>
        ...
        <el-container style="margin-top: 5%">
          ...
          <el-main style="margin-left: 5%; display: flex ">
            ...
            <el-card style="width: 70%">
              ...
              <el-card v-for="(item,index) in examData.examMultipleChoice"
                       style="margin-left: 10%;margin-right: 10%;margin: 5%">

                <el-card style="text-align: left;height: 50px;width: 70% ;margin: 2%">
                  {{ index + 1 }}:{{ item.multipleChoiceDescribe }}
                </el-card>
                <el-image :src="item.photoUrl" style="height: 30%;width: 30%;margin-left: 5%"></el-image>
                <br>
