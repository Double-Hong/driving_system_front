<template>
  ...
  >
    ...
    <template #footer>
      ...
      <el-button
          v-if="!compare(registrateData.registrateInfo.examinationCloseTime)||qualification(registrateData.registrateInfo.examinationSubject)"
          type="primary" @click="makeSureRegistrateDialogVisible=false">确定
      </el-button>
